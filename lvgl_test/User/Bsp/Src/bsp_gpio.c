...
static const GPIO_Map_t s_gpioMap[BSP_GPIO_NUMBER] = {
    ...
    [BSP_GPIO_MPU6050_SCL] = {GPIOB, GPIO_PIN_6},
    [BSP_GPIO_MPU6050_SDA] = {GPIOB, GPIO_PIN_7},
    [BSP_GPIO_ESP8266_UART_TX] = {GPIOB, GPIO_PIN_10},
    [BSP_GPIO_ESP8266_UART_RX] = {GPIOB, GPIO_PIN_11},
    [BSP_GPIO_ESP8266_EN] = {GPIOG, GPIO_PIN_13},
    [BSP_GPIO_ESP8266_RST] = {GPIOG, GPIO_PIN_14},
