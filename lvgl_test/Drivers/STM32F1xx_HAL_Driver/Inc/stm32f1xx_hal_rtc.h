...
#define IS_RTC_CALIB_OUTPUT(__OUTPUT__) (((__OUTPUT__) == RTC_OUTPUTSOURCE_NONE) || ((__OUTPUT__) == RTC_OUTPUTSOURCE_CALIBCLOCK) || ((__OUTPUT__) == RTC_OUTPUTSOURCE_ALARM) || ((__OUTPUT__) == RTC_OUTPUTSOURCE_SECOND))
