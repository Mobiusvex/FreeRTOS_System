...
LV_ATTRIBUTE_FAST_MEM static lv_draw_mask_res_t lv_draw_mask_angle(lv_opa_t *mask_buf, lv_coord_t abs_x,
    ...
    if (p->cfg.start_angle < 180 && p->cfg.end_angle < 180 && p->cfg.start_angle != 0 && p->cfg.end_angle != 0 && p->cfg.start_angle > p->cfg.end_angle) {
...
static void circ_calc_aa4(_lv_draw_mask_radius_circle_dsc_t *c, lv_coord_t radius) {
    ...
    // lv_mem_monitor(&mon);
    // RTT_PRINTF("Heap: Used=%d%% Free=%d B, Frag=%d%%\r\n", mon.used_pct, mon.free_size, mon.frag_pct);
